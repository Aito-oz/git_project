...
print('Стол -', table_quantity_1 + table_quantity_2, 'шт, стоимость', table_cost_1 + table_cost_2, 'руб')
...
print('Диван -', sofa_quantity_1 +  sofa_quantity_2, 'шт, стоимость', sofa_cost_1 + sofa_cost_2, 'руб')
"""СТУЛ"""
...
print('Стул -', chair_quantity_1 + chair_quantity_2 + chair_quantity_3, 'шт, стоимость', chair_cost_1+chair_cost_2+chair_cost_3, 'руб')
